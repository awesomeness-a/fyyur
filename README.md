...
Fyyur is a musical venue and artist booking site that facilitates the discovery and bookings of shows between local performing artists and venues. This site lets you:
...
```
git clone https://github.com/awesomeness-a/fyyur.git
cd fyyur 
```
